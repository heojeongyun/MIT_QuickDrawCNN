...
class MyDataset(Dataset):
    def __init__(self, root_path="/home/kbdsys11/quickdraw0325/data", 
                 total_images_per_class=2000, ratio=0.8, mode="train"):
    ...
    def __getitem__(self, item):
        file_ = "{}/{}.npy".format(self.root_path, CLASSES[int(item / self.num_images_per_class)])
...
if __name__ == "__main__":
    training_set = MyDataset("/home/kbdsys11/quickdraw0325/data", 500, 0.8, "train")
